 ...
 * @returns
 */
function createNumAsChar(): string {
 ...
 * @returns
 */
function createUpperAsChar(): string {
 ...
 * @returns
 */
function createLowerAsChar(): string {
 ...
 * @returns
 */
function createRandomMix(length: number = 6): string {
  // 随机字符串
...
export { createRandomPoint, createRandomPath, createRandomMix };
